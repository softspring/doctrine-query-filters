...
class FiltersTest extends TypeTestCase
{
    public static function collectionProvider(): array
    {
        return [
            ...
            [['children->field__like' => 'test'], [], Filters::MODE_AND, 'SELECT t FROM stdClass t WHERE t IN(SELECT IDENTITY(ch.parent) FROM stdClass t WHERE ch.parent = t.id AND t.field LIKE "%test%")', [
                'children' => [
